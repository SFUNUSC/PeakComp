...
all: peak_comp gnuplot_i.o lin_eq_solver.o dynamic_arrays.o

peak_comp: peak_comp.c peak_comp.h read_config.c gnuplot_i.o lin_eq_solver.o dynamic_arrays.o
	gcc peak_comp.c $(CFLAGS) -o peak_comp gnuplot_i.o lin_eq_solver.o dynamic_arrays.o
